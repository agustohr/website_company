...
<head>
    ...
    <title>April Learning Institute</title>
...
<body>
    <nav>
        <div class="wrapper">
            <div class="logo">
                <img src="gambar/698d51a19d8a121ce581499d7b701668.png" alt="logo" style="width: 120px ; float: left">
                <a href='<?php echo url_dasar()?>' style="font-size: 30px">April Learning Institute</a>
            </div>
            <div class="menu">
                <ul>
